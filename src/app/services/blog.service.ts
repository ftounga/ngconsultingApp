...
export class BlogService {
  ...
  articles: Article[] = [
    ...
    new Article('Programmation reactive avec Spring 5', '/assets/img/reactive-springboot.png', 'Ces derniers temps, la programmation réactive a gagné en popularité auprès de la communauté des développeurs et des clients en raison de sa capacité à concevoir des applications de manière déclarative, et non impérative, ce qui a entraîné des applications plus réactives et résilientes.', 'https://toungafranck.com/2018/06/04/programmation-reactive-avec-spring-5/', new Date(2019, 6, 4)),
